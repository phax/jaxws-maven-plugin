...
public class WsImportMojoITCase
{
  ...
  public void wsimport217 () throws IOException
  {
    ...
    assertFileContains (project,
                        "target/custom/sources/org/jvnet/jaxwsri/sample/MyGreeter.java",
                        "http://example.com:43210/my?wsdl");
    // dependency on jaxws-tools-2.1.7
    assertFileContains (project,
                        "target/custom/sources/org/jvnet/jaxwsri/sample/GreetersPortT.java",
                        "JAX-WS RI 2.1.7");
    // -target 2.0
    assertFileContains (project,
                        "target/custom/sources/org/jvnet/jaxwsri/sample/GreetersPortT.java",
    ...
    assertFileContains (project,
                        "target/generated-sources/test-wsimport/wsimport/test/SumUtil.java",
                        "JAX-WS RI 2.1.7");
  ...
  public void wsimport22 () throws IOException
  {
    ...
    final String v = System.getProperty ("jaxws-ri.version");
    // remove 'promoted-' from the version string if needed
    final int i = v.indexOf ('-');
    final int j = v.lastIndexOf ('-');
    final String version = i != j ? v.substring (0, i) + v.substring (j) : v;
  ...
  public void jaxwscommons62 () throws IOException
  {
    ...
    assertFileContains (project,
                        "target/generated-sources/wsimport/test/jaxwscommons_62/A.java",
                        "http://example.com/mywebservices/a.wsdl");
    assertFileContains (project,
                        "target/generated-sources/wsimport/test/jaxwscommons_62/B.java",
                        "http://example.com/mywebservices/b/b.wsdl");
    assertFileContains (project,
                        "target/generated-sources/wsimport/test/jaxwscommons_62/C.java",
                        "jaxwscommons-62/src/mywsdls/c.wsdl");
  }
  ...
  public void jaxwscommons87 ()
  {
    ...
    assertFilePresent (project,
                       "child/target/classes/org/jvnet/jax_ws_commons/jaxws/test/EchoService_Service_handler.xml");
  }
