...
public class WsImportMojoITCase
{
    ...
    @Test
    public void jaxwscommons62()
        throws IOException
    {
        project = new File( PROJECTS_DIR, "jaxwscommons-62" );

        assertFileContains( project, "target/generated-sources/wsimport/test/jaxwscommons_62/A.java",
                            "http://example.com/mywebservices/a.wsdl" );
        assertFileContains( project, "target/generated-sources/wsimport/test/jaxwscommons_62/B.java",
                            "http://example.com/mywebservices/b/b.wsdl" );
        assertFileContains( project, "target/generated-sources/wsimport/test/jaxwscommons_62/C.java",
