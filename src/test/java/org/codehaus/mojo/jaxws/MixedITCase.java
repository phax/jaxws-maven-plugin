...
public class MixedITCase
{
  ...
  public void jaxwscommons81_wsimport () throws IOException
  {
    ...
    final String version = getExpectedToolsVersion ();
  ...
  public void jaxwscommons81_wsgen () throws IOException
  {
    ...
    // //-inlineSchemas
    // assertFileContains(project, "target/wsdl/EchoService.wsdl",
    // "xs:complexType");
    ...
    // assertJarNotContains(project, "jaxwscommons81-2.2.6.jar",
    // "META-INF/wsdl/EchoService_schema1.xsd");
  ...
  {
    /*
     * String v = System.getProperty( "java.version" ); if ( v == null ) { fail(
     * "Cannot detect JAX-WS RI version in JDK: " + v ); } if ( v.startsWith(
     * "1.7" ) || v.startsWith( "1.8" ) ) { return "2.2"; } else if (
     * v.startsWith( "1.6" ) ) { return "2.1"; }
     */
