 ...
 * portable artifacts for a JAX-WS web service (into the generate test source
 * directory).
 * <p>
...
public class TestWsGenMojo extends AbstractWsGenMojo
{
  ...
  {
    final String cp = super.getExtraClasspath ();
    final StringBuilder buf = new StringBuilder ();
    final int i = cp.indexOf (File.pathSeparatorChar);
